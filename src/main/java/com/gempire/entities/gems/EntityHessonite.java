...
public class EntityHessonite extends EntityGem {
    //TO-DO: IMPLEMENT HESSONITE. Hessonite increases the chances of armor and weapons dropping from appropriate mobs, and will also increase how much is dropped at once. (Lootmaster ability)
    public EntityHessonite(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
    }
