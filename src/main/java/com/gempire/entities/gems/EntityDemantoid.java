...
public class EntityDemantoid extends EntityGem {
    //TO-DO: IMPLEMENT DEMANTOID. Demantoid will increase the amount of experience orbs that drop from mobs. (Abundance skill)
    public EntityDemantoid(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
    }
