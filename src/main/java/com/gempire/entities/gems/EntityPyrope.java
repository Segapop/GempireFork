...
public class EntityPyrope extends EntityGem {
    //TO-DO: IMPLEMENT PYROPE. Pyrope increases the chances of rare loot dropping from mobs.
    // As a treat, she can rarely have the Healer ability, because she seems elegant enough to warrant her having it.
    public EntityPyrope(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public Abilities[] possibleAbilities(){
        return new Abilities[]{
                Abilities.NO_ABILITY, Abilities.TANK, Abilities.BEEFCAKE, Abilities.POWERHOUSE, Abilities.UNHINGED, Abilities.HEALER
        };
    }
