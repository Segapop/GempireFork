package com.gempire.world;

import com.gempire.Gempire;
import com.gempire.init.ModStructures;
import com.gempire.world.gen.GempireStructureGeneration;
...
public class GempireWorldEvents {

    @SubscribeEvent
    public static void biomeLoadingEvent(final BiomeLoadingEvent event) {
        GempireStructureGeneration.generateStructures(event);
    }
